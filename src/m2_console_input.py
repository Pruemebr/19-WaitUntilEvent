...
def print_an_integer_many_times_on_one_row():
    ...
    # ------------------------------------------------------------------
    intnumber = 2*int(input('Enter an integer:'))
...
def input_it_all():
    ...
    #   The testing code is already written for you (above).
    # ------------------------------------------------------------------
    floatnumber = float(input('Give me a positive number:'))
    intnumber = int(input('Give me a positive integer:'))
    strstate = input('Give me a string:')
    for k in range(intnumber):
